...
public class MainActivity extends AppCompatActivity {
    ...
    // Game HTML lives at app/src/main/assets/game/index.html
    // AssetLoader maps /assets/ -> assets root, so the URL is /assets/game/index.html
    ...
    /**
     * Set to true when showMREC() is called but Appodeal fill isn't ready yet.
     * onMrecLoaded() auto-shows the MREC the moment fill arrives.
     * Cleared by hideMREC() so a Retry tap cancels a pending MREC correctly.
     */
    ...
    private void initWebView() {
        ...
        webView.setWebViewClient(new WebViewClientCompat() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                // The actual ad lifecycle callbacks (onInterstitialAdClosed, etc.)
                // are defined in index.html and must NOT be overridden here.
                fireJs(
                ...
                // Do NOT call webView.loadUrl() here — it would trigger onPageFinished
                // again, causing an infinite reload loop.
            }
        });

        // Single load — only ever called once here.
    ...
    private void initAppodeal() {
        ...
        Appodeal.setInterstitialCallbacks(new InterstitialCallbacks() {
            ...
            @Override public void onInterstitialShown() {
                ...
                fireJs("if(window.onInterstitialAdShown)onInterstitialAdShown();");
            }
